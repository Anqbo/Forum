 ...
 */
final class Version20240527160932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wpis ALTER date_added DROP DEFAULT');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wpis ALTER date_added SET DEFAULT CURRENT_DATE');
    }
}
